...
PATH_TO_LABELS = TRAINED_MODEL_DIR + '/Mask_label_map.pbtxt'
...
def draw_box_on_image(num_faces_detect, score_thresh, scores, boxes, classes, im_width, im_height, image_np,Line_Position2,Orientation):
    ...
    for i in range(num_faces_detect):
        ...
        if (scores[i] > score_thresh):
            ...
            #fa=alertcheck.drawboxtosafeline(image_np,p1,p2,Line_Position2,Orientation)
        if hand_cnt==0 :
            b=0
            #print(" no hand")
        else:
